...
- (void)setup
{
    ...
    _deleteLabel.textColor = TimeLineCellHighlightedColor;
    _deleteLabel.userInteractionEnabled = YES;
    _deleteLabel.text = @"删除";

    UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(tapImageView:)];
    [_deleteLabel addGestureRecognizer:tap];
    ...
    NSArray *views = @[_iconView, _nameLable, _contentLabel, _moreButton, _picContainerView, _timeLabel,_deleteLabel, _operationButton, _operationMenu, _commentView];
    ...
    _deleteLabel.sd_layout
    .leftSpaceToView(_timeLabel,10)
    .topSpaceToView(_picContainerView, 10)
    .heightIs(15)
    .autoHeightRatio(0);
    [_deleteLabel setSingleLineAutoResizeWithMaxWidth:50];
...
- (void)setModel:(SDTimeLineCellModel *)model
{
    ...
    [_iconView sd_setImageWithURL:[NSURL URLWithString:model.iconName] placeholderImage:[UIImage imageNamed:@"展位图.png"]];
    ...
    if([model.userId isEqualToString:@""]){//默认的空ID判断
