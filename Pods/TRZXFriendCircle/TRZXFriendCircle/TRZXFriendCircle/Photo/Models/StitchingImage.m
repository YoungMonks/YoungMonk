...
//    [self generateImageViewSideLengthWithCanvasView:canvasView byImageViewsCount:imageViews.count];
    ...
    NSInteger imageViewW = (canvasView.bounds.size.width-_marginValue)/2;


    if ([imageViews count] == 1)
    {
        UIImageView* imageView_1 = imageViews[0];
        imageView_1.frame = CGRectMake(0, 0, canvasView.bounds.size.width, canvasView.bounds.size.width);
    }
    else if ([imageViews count] == 2)
    {

        UIImageView* imageView_1 = imageViews[0];
        imageView_1.frame = CGRectMake(0, 0, imageViewW, imageViewW*2);

        UIImageView* imageView_2 = imageViews[1];
        imageView_2.frame = CGRectMake(imageViewW+_marginValue, 0, imageViewW, imageViewW*2);
    ...
    else if ([imageViews count] == 3)
    {
        ...
        UIImageView* imageView_2 = imageViews[1];
        imageView_2.frame = CGRectMake(imageViewW+_marginValue, 0, imageViewW, imageViewW);

        UIImageView* imageView_3 = imageViews[2];
        imageView_3.frame = CGRectMake(imageViewW+_marginValue, imageViewW+_marginValue, imageViewW, imageViewW);

    }
    else if ([imageViews count] == 4)
    {
        UIImageView* imageView_1 = imageViews[0];
        imageView_1.frame = CGRectMake(0, 0, imageViewW, imageViewW);

        UIImageView* imageView_2 = imageViews[1];
        imageView_2.frame = CGRectMake(0, imageViewW+_marginValue, imageViewW, imageViewW);

        UIImageView* imageView_3 = imageViews[2];
        imageView_3.frame = CGRectMake(imageViewW+_marginValue, 0, imageViewW, imageViewW);

        UIImageView* imageView_4 = imageViews[3];
        imageView_4.frame = CGRectMake(imageViewW+_marginValue, imageViewW+_marginValue, imageViewW, imageViewW);
