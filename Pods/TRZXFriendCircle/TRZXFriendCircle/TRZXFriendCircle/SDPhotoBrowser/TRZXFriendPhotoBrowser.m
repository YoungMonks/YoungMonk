...
@implementation TRZXFriendPhotoBrowser 
{
...
//    indexLabel.backgroundColor = [[UIColor redColor] colorWithAlphaComponent:0.5];
...
- (void)layoutSubviews
{
    ...
    _saveButton.frame = CGRectMake(self.bounds.size.width-70, 30, 50, 25);
}
