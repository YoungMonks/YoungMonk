//
//  TRZXFriendLineCellOperationMenu.m
...
@implementation TRZXFriendLineCellOperationMenu
...
- (void)setup
{
    ...
    _likeButton = [self creatButtonWithTitle:@"赞" image:[UIImage imageNamed:@"TRZXLikeW"] selImage:[UIImage imageNamed:@""] target:self selector:@selector(likeButtonClicked)];
