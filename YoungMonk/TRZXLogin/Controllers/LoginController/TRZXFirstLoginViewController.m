//
//  TRZXFirstLoginViewController.m
//  TRZXLogin
//
...
@interface TRZXFirstLoginViewController ()
...
@implementation TRZXFirstLoginViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    [[NSBundle bundleForClass:[self class]] loadNibNamed:@"TRZXFirstLoginViewController" owner:self options:nil];
...
//注册
- (IBAction)registeredBtn:(UIButton *)sender {
    TRZXRegisteredViewController *viewController = [[TRZXRegisteredViewController alloc] init];
...
- (void)Login_Api{
    ...
    [TRZXNetwork requestWithUrl:nil params:params method:POST cachePolicy:NetworkingReloadIgnoringLocalCacheData callbackBlock:^(id object, NSError *error) {
        if ([object[@"status_code"] isEqualToString:@"200"]) {
            ...
            [TRZXLoginUserDefaults saveUserDefaults_NSObject:object objKey:userKey];
